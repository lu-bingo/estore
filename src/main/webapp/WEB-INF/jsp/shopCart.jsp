	...
	<div class="top">
    	<div class="top_center">
            <ul class="top_bars">
                ...
                <li><a href="ToIndexServlet">返回首页<span class="jt_down"></span></a></li>
            </ul>
        </div>
    </div>
    <!--头部-->
...
<!--中间部分div-->
<div class="empty">
	<div class="peisong"><pre>全部商品  ${car.size } </pre></div>
	<div class="mainCenter">
		...
		<c:forEach items="${car.orderLines }" var="entry"  varStatus="status">
            <form>
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <img src="${entry.value.book.image}" width="70px" height="100px">
                                 <span>
 ...
 -->
             <!-- <div class="bb">
                ...
                <div class="allButtom">
                    ...
                    <span>已选择<font>${car.numSum }</font>件商品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;总价(不含运费)：<font>¥${car.cost }元</font></span>
                </div>
		</div>
	</div>
</div>
