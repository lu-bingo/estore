...
<body>
    ...
    <div class="content">
		...
		<form action="commit" name="orderForm" method="post">
    		...
    		<div class="centerTop">
    			...
    			<ul class="adres">
					<c:forEach items="${addresses }" var="addr">
			    		<li>
			    			<input type="radio" name="addrId" value="${addr.id }" style="width:50px">
			    			${addr.receiveName }&nbsp;&nbsp;&nbsp;${addr.phone }&nbsp;&nbsp;&nbsp;
			    			${addr.address }
			    		</li>
					</c:forEach>	
		    	</ul>
    		...
    		<div class="money">
    			<span><font>${car.numSum }</font>件商品，总商品金额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${car.cost }</span>
