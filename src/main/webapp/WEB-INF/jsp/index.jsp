...
<body>
	...
	<div class="header3">
		...
		<div class="h3_center">
			...
			<p>
				<c:forEach items="${categorielist }" var="firstCategory">
		...
		<div class="h3_right">
			...
			<div class="tsc">
				<a href="user/addshopcarServlet">去购物车结算</a> <span class="sj_right"></span>
			</div>
		</div>
	</div>
	<!--头部导航-->
					...
					<ul>
						<c:forEach items="${books }" var="book">
							<li><a href="toViewBookServlet?id=${book.id }"><img
									src="${book.image }" width="110px" height="130px" /></a> <a
