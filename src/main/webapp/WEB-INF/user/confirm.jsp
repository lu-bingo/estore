...
<body>
	...
	<div class="top">
    	<div class="top_center">
            <ul class="top_bars">
            	<li><a href="user/addshopcarServlet">退出</a>|</li>
                <li><a href="user/toOrderListServlet">我的订单<span class="jt_down"></span></a>|</li>
    ...
    <div class="content">
		...
		<form action="user/toOrderListServlet" name="orderForm" method="post">
    			...
    			<ul class="adres">
					<c:forEach items="${addresslist }" var="address">
			    		<li>
			    			...
			    			${address.receiveName }&nbsp;&nbsp;&nbsp;${address.phone }&nbsp;&nbsp;&nbsp;
			    			${address.address }
			    		</li>
					</c:forEach>	
		    	</ul>
    		...
    		<p class="singleP"><b>送货清单</b><span><a href="user/addshopcarServlet">返回修改购物车</a></span></p>
    		<div class="bigDiv">
    			<div class="twoDiv">
    			<b>商家：briup自营</b>
    		...
    		<div class="money">
    			<span><font>${car.sumNum}</font>件商品，总商品金额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${car.cost }</span>
